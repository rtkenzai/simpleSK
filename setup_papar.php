...
<body>
<center>
<h2>KEMASKINI MAKLUMAT SISTEM</h2>
</center>
...
value="<?php echo $kata1; ?>" style="text-transform: uppercase">
	<br>
Keterangan<br>
<input type="text" name="kat" size="60" 
value="<?php echo $lanjut1; ?>" style="text-transform: uppercase">
	<br>
Anjuran<br>
<input type="text" name="sempena" size="60" 
value="<?php echo $kata2; ?>" style="text-transform: uppercase">
	<br>
Tempat<br>
<input type="text" name="tempat" size="60" 
value="<?php echo $lanjut2; ?>" style="text-transform: uppercase">
	<hr>
Tarikh Tutup Pendaftaran<br>
<input type="date" name="tutup" 
value="<?php echo $tamat_daftar; ?>">
	<br>
Tarikh Tamat Juri<br>
<input type="date" name="umum"
value="<?php echo $tamat_hakim; ?>">
	<br>

...
$result = mysqli_query($con,"UPDATE item SET item='$item', markah='$markah'  
WHERE iditem=$iditem");
...
$hapuskan2 = mysqli_query($con,"DELETE FROM markah WHERE iditem='$iditem'");
...
<body>
<center>
<h2><U>SENARAI ITEM PEMARKAHAN</U></h2>
</center>
...
$row=0;
#PAPAR REKOD
   $sql = "SELECT * FROM item WHERE iditem='$IDITEM' ORDER BY markah DESC";
...
<form method="POST">
<td>
<input type="text" name="item" value="<?php echo $infoD['item'];?>">
</td>
<td>
<input type="text" name="markah" value="<?php echo $infoD['markah'];?>">
</td>			
<td>
<input type="text" name="iditem" value="<?php echo $infoD['iditem'];?>" hidden>
